...
public class BackpackBlockEntity extends BaseContainerBlockEntity /*implements IAnimatable*/ {
    ...
    public BackpackBlockEntity(BlockPos pWorldPosition, BlockState pBlockState) {
        ...
        this.items = NonNullList.withSize(BackpackConfig.INSTANCE.rows.get() * BackpackConfig.INSTANCE.columns.get(), ItemStack.EMPTY);
    }
...
//    }
    ...
    public int getContainerSize() {
        return BackpackConfig.INSTANCE.rows.get() * BackpackConfig.INSTANCE.columns.get();
    }
    ...
    protected AbstractContainerMenu createMenu(int pContainerId, Inventory pInventory) {
        return new BackpackBEMenu(pContainerId, pInventory, this, getBlockPos(), BackpackConfig.INSTANCE.rows.get(), BackpackConfig.INSTANCE.columns.get());
    }
