...
public class BackpackBEContainerScreen extends ContainerScreen<BackpackBEContainer> {
    ...
    public BackpackBEContainerScreen(BackpackBEContainer handler, PlayerInventory player, ITextComponent title) {
