...
public class BackpackBEContainerScreen extends AbstractContainerScreen<BackpackBEContainer> {
    ...
    public BackpackBEContainerScreen(BackpackBEContainer handler, Inventory player, Component title) {
